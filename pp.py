...
import pyfiglet
print(O + ' ')
table = Table(title='Tools Check tiktok Accounts Email', style='red')
table.add_column('The Tool By : XF', style='green')
table.add_row('My User : @DevEvii', style='green')
table.add_row('My Channel : @C35CS', style='Cyan')
table.add_row('My Channel 2 : @Q8_10', style='yellow')

console = Console()
console.print(table)
XF = Console()
token = input(O + ' -Enter Your Tokne : ')
ID = input(O + ' -Enter Your ID : ')
print('                    ')
import requests
def sui():
  while True:
    try:
        ...
        if '"Dev":"@C15CS","Email":"Good"' in res:
